...
锚点：`sdk-tools.d.ts:14`、`sdk-tools.d.ts:319`
...
锚点：`sdk-tools.d.ts:479`

#### 输出定义

- `McpOutput = string`

锚点：`sdk-tools.d.ts:247`
